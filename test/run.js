...
const suites = ['text-locate.test.js', 'page-content.test.js', 'write-queue.test.js', 'backup.test.js', 'highlight-style.test.js', 'file-import.test.js', 'highlight-order.test.js', 'cornell-export.test.js', 'site-rules.test.js'];
